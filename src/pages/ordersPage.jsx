...
export default function OrdersPage() {
    ...
    return (
    <div className="w-full max-h-full flex flex-col justify-center p-10 relative bg-primary text-text">

        <h2 className="text-2xl font-bold mb-4 text-secondary">My Orders</h2>
