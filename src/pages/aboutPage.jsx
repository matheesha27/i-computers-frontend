...
export default function AboutPage() {
    ...
    return (
        <div className="w-full min-h-[calc(100vh-100px)] bg-[url(/login.jpg)] bg-center bg-cover bg-no-repeat flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-center lg:px-10 py-10 bg-black/40 relative">
                <img
                    src="/logo.png"
                    alt="logo"
                ...
                <h1 className="text-3xl lg:text-5xl font-semibold text-accent mb-4 text-center">
            ...
            <div className="w-full lg:w-1/2 h-full flex justify-center items-center p-4 lg:p-6 backdrop-blur-xs relative overflow-hidden">
                <div
                    className="flex w-full transition-transform duration-700 ease-in-out"
                    style={{ transform: `translateX(-${slide * 100}%)` }}
                >
                    <div className="min-w-full">
                        <div className="text-base lg:text-lg text-primary font-light bg-white/10 p-6 shadow-2xl rounded-xl max-w-xl">
                            <p className="mb-4">
                ...
                {slide > 0 && (
                    <button
                        ...
                        className="absolute left-2 lg:left-4 text-2xl lg:text-3xl text-accent hover:scale-110 transition"
                    >
                        <FaChevronLeft />
                    </button>
                )}
                ...
                {slide < 1 && (
                    <button
                        onClick={() => setSlide(slide + 1)}
                        className="absolute right-2 lg:right-4 text-2xl lg:text-3xl text-accent hover:scale-110 transition"
                    >
                        <FaChevronRight />
                    </button>
                )}
